...
public class MainActivity extends AppCompatActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				text.putExtra(Intent.EXTRA_EMAIL,
					new String[] { "contact@nitdgplug.org" });
	...
	public boolean onNavigationItemSelected(MenuItem item) {
		Intent glgw = new Intent(MainActivity.this, GlugwebActivity.class);
		Intent glgm = new Intent(MainActivity.this, MuktiwebActivity.class);
		Intent shareintent = new Intent(Intent.ACTION_SEND);
		shareintent.setType("application/vnd.android.package-archive");
		Intent play = new Intent(android.content.Intent.ACTION_VIEW);
		play.setData(Uri.parse(
			"https://play.google.com/store/apps/details?id=nitdgp.glug.somesh1995.mukti2017_2&hl=en"));

		int id = item.getItemId();

		if (id == R.id.workshop) {
			Intent worksh = new Intent(this, WorkshopsActivity.class);
			startActivity(worksh);
		} else if (id == R.id.webg) {

			startActivity(glgw);
			Toast.makeText(this, "GNU/LINUX USERS'S GROUP", Toast.LENGTH_SHORT)
				.show();
		} else if (id == R.id.webm) {
			startActivity(glgm);
			Toast.makeText(this, "MUKTI", Toast.LENGTH_SHORT).show();
		} else if (id == R.id.aboutus) {
			Intent con = new Intent(this, ContactsActivity.class);
			startActivity(con);
